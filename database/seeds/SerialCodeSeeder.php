...
class SerialCodeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('serial_code')->insert(['sc_id' => '51bdb123-a54e-335d-9422-730321cb2369', 'sc_code' => 'CT', 'sc_description' => 'Cash Transfer', 'sc_active' => 'Y', 'sc_created_by' => '47e71f7c-548c-36ad-8ba7-52652a4698bc', 'sc_created_on' => date('Y-m-d H:i:s')]);
        DB::table('serial_code')->insert(['sc_id' => '7d2ae74c-d95a-3cdf-bd6c-18f3c5c421e1', 'sc_code' => 'PI', 'sc_description' => 'Puchase Invoice', 'sc_active' => 'Y', 'sc_created_by' => '47e71f7c-548c-36ad-8ba7-52652a4698bc', 'sc_created_on' => date('Y-m-d H:i:s')]);
