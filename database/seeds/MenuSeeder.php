...
class MenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('menu')->insert(['mn_id' => 'c388342a-7bb3-3318-b7a9-80fe0a0920df', 'mn_name' => 'Finance', 'mn_code' => 'finance', 'mn_parent' => '8280e327-d322-35bd-a479-63d37c056610', 'mn_order' => 1, 'mn_icon' => 'fa fa-money', 'mn_active' => 'Y', 'mn_created_by' => '47e71f7c-548c-36ad-8ba7-52652a4698bc', 'mn_created_on' => date('Y-m-d H:i:s')]);
