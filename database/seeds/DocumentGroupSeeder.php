...
class DocumentGroupSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('document_group')->insert(['dcg_id' => 'f9c9af32-095f-3c4b-9fe9-6e5c04b98f55', 'dcg_code' => 'si', 'dcg_description' => 'Sales Invoice', 'dcg_table' => 'sales_invoice', 'dcg_value_field' => 'si_id', 'dcg_text_field' => 'si_number', 'dcg_active' => 'Y', 'dcg_created_by' => '47e71f7c-548c-36ad-8ba7-52652a4698bc', 'dcg_created_on' => date('Y-m-d H:i:s')]);
        DB::table('document_group')->insert(['dcg_id' => '34a75298-23c1-3c18-a95f-6dab65b770f8', 'dcg_code' => 'pi', 'dcg_description' => 'Expenses', 'dcg_table' => 'purchase_invoice', 'dcg_value_field' => 'pi_id', 'dcg_text_field' => 'pi_number', 'dcg_active' => 'Y', 'dcg_created_by' => '47e71f7c-548c-36ad-8ba7-52652a4698bc', 'dcg_created_on' => date('Y-m-d H:i:s')]);
