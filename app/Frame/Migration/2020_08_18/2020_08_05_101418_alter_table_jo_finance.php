...
class AlterTableJoFinance extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('job_sales', function (Blueprint $table) {
            $table->bigInteger('jos_tax_id')->unsigned()->nullable(true)->change();
        });
        Schema::table('job_purchase', function (Blueprint $table) {
            $table->bigInteger('jop_tax_id')->unsigned()->nullable(true)->change();
        });
