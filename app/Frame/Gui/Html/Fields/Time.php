...
class Time extends Text
{
    ...
    private function createTime(): string
    {
        ...
        $this->addAttribute('maxlength', '8');
        $result = '';
        $result .= '<div class="input-group date" id="' . $this->IdTime . '_div">';
    ...
    {
        $varJs = $this->IdTime . '_var';
        $idJs = $this->IdTime . '_div';
        $javascript = '<script type="text/javascript">';
        $javascript .= 'var ' . $varJs . " = new App.Time('" . $idJs . "');";
