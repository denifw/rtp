 ...
 * @copyright  2019 PT Spada Media Informatika
 */
class PlanningJob extends AbstractDashboardModel
{
    ...
    public function __construct(array $parameters)
    {
        ...
        parent::__construct(get_class($this), 'planningJob');
    ...
    {
        # Arrive soon
        $arriveJob = new \App\Model\DashboardItem\Table\AutoReloadPlanningJob('PlanningJobTbl');
