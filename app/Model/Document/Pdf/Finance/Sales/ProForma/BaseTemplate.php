...
namespace App\Model\Document\Pdf\Finance\Sales\ProForma;
...
class BaseTemplate extends AbstractBasePdf
{
    ...
    {
        parent::__construct(Trans::getFinanceWord('proFormaInvoice') . '.pdf');
    ...
    public function loadContent(): void
    {
        ...
        try {
            ...
            $this->MPdf->WriteHTML($this->createDocumentTitle(Trans::getFinanceWord('proFormaInvoice'), 'font-20',
    ...
    protected function getDetailSalesView(): string
    {
        ...
        $tbl->setHeaderRow([
            ...
            'sid_rate' => Trans::getFinanceWord('rate') . ' (IDR)',
            'sid_tax_name' => Trans::getFinanceWord('tax'),
            'sid_sub_total' => Trans::getFinanceWord('total') . ' (IDR)',
        ]);
        $rows = [];
        $i = 0;
