...
class DocumentGroupDao extends AbstractBaseDao
{
    ...
    {
        $wheres = [];
        $wheres[] = SqlHelper::generateStringCondition('dcg_id', $referenceValue);
    ...
    public static function loadData(array $wheres = [], array $orderBy = [], int $limit = 0, int $offset = 0): array
    {
        ...
        if (empty($orderBy) === false) {
            ...
            $query .= ' ORDER BY dcg_code, dcg_id';
        }
        if ($limit > 0) {
    ...
    public static function loadSingleSelectData($textColumn, array $wheres = [], array $orders = []): array
    {
        ...
        return parent::doPrepareSingleSelectData($data, $textColumn, 'dcg_id');
    }
