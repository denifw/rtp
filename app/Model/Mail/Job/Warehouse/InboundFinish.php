 ...
 * @copyright  2021 PT Makmur Berkat Teknologi.
 */
class InboundFinish extends BaseJobMail
{
    /**
    ...
    {
        parent::__construct('mail.master_mail_template', 'inboundfinish', $parameters);
    }
    ...
    protected function createJobInformation(): string
    {
        $text = Trans::getNotificationWord($this->NotificationCode . '.status', '', [
            'jo_status' => '<span class="label label-success">' . Trans::getWord('finish') . '</span>'
        ]);
