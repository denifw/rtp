 ...
 * @copyright  2021 PT Makmur Berkat Teknologi.
 */
class InboundStartPutAway extends BaseJobMail
{
    /**
    ...
    {
        parent::__construct('mail.master_mail_template', 'inboundstartputaway', $parameters);
    }
    ...
    protected function createJobInformation(): string
    {
        $text = Trans::getNotificationWord($this->NotificationCode . '.status', '', [
            'jo_status' => '<span class="label label-primary">' . Trans::getWord('putAwayProcess') . '</span>'
        ]);
