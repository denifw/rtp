 ...
 * @copyright  2021 PT Makmur Berkat Teknologi.
 */
class InboundCompleteUnload extends BaseJobMail
{
    /**
    ...
    {
        parent::__construct('mail.master_mail_template', 'inboundcompleteunload', $parameters);
    }
    ...
    protected function createJobInformation(): string
    {
        $text = Trans::getNotificationWord($this->NotificationCode . '.status', '', [
            'jo_status' => '<span class="label label-aqua">' . Trans::getWord('unloadCompleted') . '</span>'
        ]);
