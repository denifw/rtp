 ...
 * @copyright  2020 PT Makmur Berkat Teknologi.
 */
class SalesQuotation extends AbstractListingModel
{
    ...
    public function __construct(array $parameters)
    {
        ...
        parent::__construct(get_class($this), 'slsQt');
    ...
    public function loadSearchForm(): void
    {
        ...
        $this->ListingForm->addField(Trans::getFinanceWord('customer'), $relationField);
    ...
    public function loadResultTable(): void
    {
        ...
        $this->ListingTable->setHeaderRow([
            ...
            'qt_relation' => Trans::getFinanceWord('customer'),
