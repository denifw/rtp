 ...
 * @copyright  2019 PT Spada Media Informatika
 */
class SalesOrder extends AbstractListingModel
{
    ...
    public function __construct(array $parameters)
    {
        ...
        parent::__construct(get_class($this), 'so');
    ...
    public function loadSearchForm(): void
    {
        ...
        $statusField = $this->Field->getSelect('so_status', $this->getStringParameter('so_status'));
...
//        $statusField->addOption(Trans::getWord('complete'), '4');
    ...
    public function loadResultTable(): void
    {
        ...
        $this->ListingTable->setHeaderRow([
            ...
            'so_consolidate' => Trans::getWord('consolidate'),
        ...
        $this->ListingTable->setColumnType('so_consolidate', 'yesno');
        ...
        $this->ListingTable->setViewActionByHyperlink($this->getViewRoute(), ['so_id']);
        if ($this->isAllowUpdate() === true) {
            $this->ListingTable->setUpdateActionByHyperlink($this->getUpdateRoute(), ['so_id']);
        }
    }
    ...
    private function getWhereCondition(): array
    {
        ...
        $wheres[] = SqlHelper::generateNullCondition('so.so_soa_id');
