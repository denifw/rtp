...
class SerialCode extends AbstractFormModel
{
    ...
    public function __construct(array $parameters)
    {
        ...
        parent::__construct(get_class($this), 'sc', 'sc_id');
    ...
    {
        $colVal = [
            'sc_code' => mb_strtoupper($this->getStringParameter('sc_code')),
...
//        $data = SystemSettingDao::loadData($wheres);
...
//                'sn_srv_id' => $this->getStringParameter('sn_srv_id'),
//                'sn_srt_id' => $this->getStringParameter('sn_srt_id'),
...
//    {
//        $officeField = $this->Field->getSelect('sn_of_id', $this->getStringParameter('sn_of_id'));
