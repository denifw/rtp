...
use App\Model\Dao\System\CurrencyDao;
...
class Currency extends AbstractFormModel
{
    ...
    {
        parent::__construct(get_class($this), 'currency', 'cur_id');
    ...
    {
        $colVal = [
            'cur_cnt_id' => $this->getIntParameter('cur_cnt_id'),
            'cur_name' => $this->getStringParameter('cur_name'),
            'cur_iso' => $this->getStringParameter('cur_iso'),
