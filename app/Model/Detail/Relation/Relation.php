...
class Relation extends AbstractFormModel
{
    ...
    public function __construct(array $parameters)
    {
        ...
        parent::__construct(get_class($this), 'relation', 'rel_id');
    ...
    protected function doUpdate(): void
    {
        if ($this->getFormAction() === 'doUpdateOffice') {
            ...
            if ($this->isValidParameter('cp_id') === false) {
                $sn = new SerialNumber($this->User->getSsId());
                $cpNumber = $sn->loadNumber( 'ContactPerson', $this->getIntParameter('cp_of_id'), $this->getDetailReferenceValue());
            ...
            $colVal = [
                'rty_rel_id' => $this->getDetailReferenceValue(),
    ...
    {
        return RelationDao::getByReference($this->getDetailReferenceValue());
    }
    ...
    public function loadForm(): void
    {
        ...
        if ($this->isInsert() === true) {
            ...
            $this->Tab->addPortlet('document', $this->getBaseDocumentPortlet('relation', $this->getDetailReferenceValue()));
        }
    }
    ...
    private function getGeneralFieldSet(): Portlet
    {
        ...
        if ($this->isUpdate() === true) {
            ...
            $fieldSet->addField(Trans::getCrmWord('number'), $relNumber);
    ...
    private function getCompanyProfileFieldSet(): Portlet
    {
        ...
        $mainContactField->addParameterById('cp_rel_id', 'rel_id', Trans::getCrmWord('customer'));
    ...
    private function getRelationTypeFieldSet(): Portlet
    {
        ...
        $wheres[] = SqlHelper::generateNumericCondition('rty_rel_id', $this->getDetailReferenceValue());
    ...
    private function getTaskPortlet(): Portlet
    {
        ...
        $wheres[] = SqlHelper::generateNumericCondition('tsk_rel_id', $this->getDetailReferenceValue());
        ...
        $btnTsk->setPopup('task/detail', ['tsk_rel_id' => $this->getDetailReferenceValue()]);
    ...
    private function getDealPortlet(): Portlet
    {
        ...
        $table->setDisableLineNumber();
        $table->setDisableOrdering();
        $wheres[] = SqlHelper::generateNumericCondition('dl_rel_id', $this->getDetailReferenceValue());
        ...
        $btnDl->setPopup('deal/detail', ['dl_rel_id' => $this->getDetailReferenceValue()]);
    ...
    private function getTicketPortlet(): Portlet
    {
        ...
        $table->setDisableLineNumber();
        $table->setDisableOrdering();
        $wheres[] = SqlHelper::generateNumericCondition('tc_rel_id', $this->getDetailReferenceValue());
        ...
        $btnDl->setPopup('ticket/detail', ['tc_rel_id' => $this->getDetailReferenceValue()]);
        $btnDl->setIcon(Icon::Plus)->btnPrimary()->pullRight();
        $portlet->addTable($table);
        $portlet->addButton($btnDl);
