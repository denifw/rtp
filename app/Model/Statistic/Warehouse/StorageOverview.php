...
namespace App\Model\Statistic\Warehouse;
 ...
 */
class StorageOverview extends AbstractStatisticModel
{
    ...
    public function __construct(array $parameters)
    {
        ...
        parent::__construct(get_class($this), 'storageOverview');
    ...
    private function doPrepareWarehouseData(array $data): void
    {
        ...
        foreach ($data as $row) {
            ...
            $goods = [
                ...
                'gd_name' => $row['gd_name'],
                'gd_full_name' => $row['br_name'] . ' ' . $row['gdc_name'] . ' ' . $row['gd_name'],
                'gd_uom' => $row['uom_code'],
            ];
