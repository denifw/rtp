...
return [
    ...
    'invalidCheckFound' => 'Invalid check found.',
    'exportXlsNotConfigure' => "Export xls didn't configure yet.",
    'successUpdate' => 'Update successfully complete.',
    'successInsert' => 'Insert successfully complete.',
    'failedUpdate' => 'Update Failed. Please check the invalid message',
    'failedInsert' => 'Insert Failed. Please check the invalid message',
    'doNotHavePermission' => "You don't have permission to access this page.",
    ...
    'canNotFoundPage' => "We can not find the page that you're looking for.",
    'noMenuFound' => 'There is no menu data found.',
    'noDataFound' => 'There is no data found.',
    'noActivePageFound' => 'There is no active page found.',
    # Done
    ...
    'expired_access' => 'You login access has been expired, please re-login again.',
    ...
    'pagingInfo' => 'Showing :dataPerRow of :totalData data.',
