...
<head>
    ...
    <link href="{{asset('assets/vendors/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css')}}"
          rel="stylesheet">
    <link href="{{asset('assets/vendors/datatables.net-bs/css/dataTables.bootstrap.css')}}"
          rel="stylesheet">
...
<body class="{{$body_class}}" onload="App.showLoading()">
            ...
            <div class="left_col scroll-view">
                <div class="navbar nav_title">
                    <a href="{{url('/')}}" class="site_title">
                        <img src="{{$app_logo}}" alt="{{$app_name}}" style="height: 45px; margin-top: 5px">
                    </a>
